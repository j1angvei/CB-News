...
# Gson uses generic sourceType information stored in a class file when working with fields. Proguard
...
# Retain generic sourceType information for use by reflection by converters and adapters.
-keepattributes Signature
